...
int main()
{
    ...
    char animal[3];
        ...
        for(i = 0; i < n ; i++){
            ...
            if(strcmp(animal,"C")== 0){ //UTILIZA A FUNCAO STRCMP PARA COMPARAR SE TEM ALGUMA LETRA C R OU S, SE FOR = 0 ENTAO VERDADEIRO
                coelhos += num;
            }
        ...
        printf("Percentual de coelhos: %.2f %%\n", (float)coelhos / soma * 100);
        printf("Percentual de ratos: %.2f %%\n", (float)ratos / soma * 100);
        printf("Percentual de sapos: %.2f %%\n", (float)sapos / soma * 100);
